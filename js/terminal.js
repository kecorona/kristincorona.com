...
var whois = 'Kristin Corona is a software engineer currently employed as a Freelance Web Developer.<br/>"An insatiable thirst for knowledge, a commitment to mindfulness and nutrition, and an unhealthy lust for new technologies."';
var contact = "Email: <a href='mailto:kristincorona@gmail.com'>kristincorona@gmail.com</a>";
...
help[3]=["whois","Who is Kristin Corona"];
...
help[11]=["hire","Hire Kristin Corona."];
help[12]=["shortcut","View Kristin's resume page"]
...
function prompt(){
	...
	currLine.innerHTML="<span>visitor@kristincorona.com"+currLoc+":~$ </span>";
	addBlank();
...
function formatLS(dirs,files,isWeb){
	...
	for(var i=0;i<entries.length;i++){
		...
		if(isIn(dirs,entries[i])){ 
			...
			var address = "http://kristincorona.com/web1/" + entries[i].toLowerCase() + ".html";
